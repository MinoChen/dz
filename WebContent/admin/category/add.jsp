...
<body>
	...
	<div class="formbody">
		...
		<form action="${basePath}CategoryServlet?method=addCategory" name="ff" method="post" onsubmit="return checkValue()">
			<ul class="forminfo">
				<li>
				<label style="width: 120px;">
				类别id：
				</label>
				<input id="category_id" name="category_id" type="text" class="dfinput" />
				<i>类别id为纯数字</i>
				</li>
				<li>
				<label style="width: 120px;">
				...
				<input id="category_name" name="category_name" type="text" class="dfinput" />
				<i>类别名称</i>
				</li>
				<li>
				<label>&nbsp;</label>
